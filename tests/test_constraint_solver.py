...
def test_CSP_basics_1_benchmark(benchmark):
    ...
    solution = benchmark(sets.CSP_basics_1, a=[1, 2, 3], b=[4, 5, 6])
    expected = [
        {"a": 3, "b": 6},
        {"a": 3, "b": 5},
        {"a": 3, "b": 4},
...
def test_CSP_basics_2_benchmark(benchmark):
    ...
    solution = benchmark(sets.CSP_basics_2, a=[1, 2, 3], b=[4, 5, 6])
...
def CSP_basics_3_benchmark(benchmark):
    ...
    solution = benchmark(sets.CSP_basics_3, a=[1, 2, 3], b=[4, 5, 6])
    expected = [
        {1: 6, 2: 5, 3: 4},
        {1: 6, 2: 4, 3: 5},
        {1: 5, 2: 6, 3: 4},
...
def test_CSP_rooks_benchmark(benchmark):
    ...
    solution = benchmark(
        sets.CSP_rooks, cols=range(3), rows=range(3)  # pylint: disable=W1638
    )
    expected = [
        {0: 2, 1: 1, 2: 0},
        {0: 2, 1: 0, 2: 1},
