...
def test_count_benchmark(benchmark):
    ...
    copied_boolean_list = benchmark(booleancopies.bcopies_oft, inputlength="100")
...
def test_boolean_count_multiple(boolean_count, expected_count):
    ...
    copied_boolean_list = booleancopies.bcopies_oft(boolean_count)
...
def test_boolean_count_single():
    """Returns output with correct number of copies"""
    copied_boolean_list = booleancopies.bcopies_oft("10")
